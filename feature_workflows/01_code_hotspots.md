...
| --- | --- | --- | --- |
| `src/trotters_trader/research_runtime.py` | about `3629` lines, about `103` defs | runtime state, campaign orchestration, director orchestration, notifications, agent dispatch, service-heartbeat exports, and now launch-claim recovery all live together | `FW-003`, `FW-005`, `FW-006`, `FW-008`, `FW-014`, `FW-029` |
